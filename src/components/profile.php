...
if ($action === 'delete') {
    ...
    try {
        ...
        $redirect_map = [
            'regular' => 'http://192.168.1.96/ICWS-Personnel-Profiling/src/components/manage_regEmp.php',
...
<?php if (!empty($success)): ?>
  <div class="alert alert-success">
    ...
    <a href="<?= htmlspecialchars($redirect_url ?? 'http://192.168.1.96/ICWS-Personnel-Profiling/src/components/personnel_record.php') ?>" class="alert-link">Go to Manage Page</a>.
  </div>
<?php endif; ?>
        ...
        <div class="col-md-3">
          <div class="card profile-card text-center">
            <form method="POST" enctype="multipart/form-data">
              ...
              <img
                  id="profileImage"
                  src="<?php echo !empty($employee['profile_picture']) ? 'http://192.168.1.96/ICWS-Personnel-Profiling' . $employee['profile_picture'] : '../../assets/profile.jpg'; ?>"
                  alt="Profile Picture"
        ...
        <div class="col-md-9">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="btn-container">
                ...
                <a href="<?php 
                    if ($emp_type === 'regular') {
                        echo 'http://192.168.1.96/ICWS-Personnel-Profiling/src/components/edit_regular.php?Emp_No=' . urlencode($employee['Emp_No']);
                    } elseif ($emp_type === 'job_order') {
                        echo 'http://192.168.1.96/ICWS-Personnel-Profiling/src/components/edit_jo.php?Emp_No=' . urlencode($employee['Emp_No']);
                    } elseif ($emp_type === 'contract') {
                        echo 'http://192.168.1.96/ICWS-Personnel-Profiling/src/components/edit_cos.php?Emp_No=' . urlencode($employee['Emp_No']);
                    } else {
                ...
                <a href="http://192.168.1.96/ICWS-Personnel-Profiling/src/components/print_profile.php?Emp_No=<?= urlencode($employee['Emp_No']) ?>" target="_blank" class="btn btn-warning btn-sm">Print</a>
            </div>
        </div>
          ...
          <?php echo "<!-- emp_type: $emp_type | employee[emp_type]: " . ($employee['emp_type'] ?? 'NOT SET') . " | employment_type: $employment_type -->"; ?>
            ...
            function deleteProfile() {
              if (confirm("Are you sure you want to delete this profile? This action cannot be undone.")) {
                  ...
                  window.location.href = "http://192.168.1.96/ICWS-Personnel-Profiling/src/components/delete_profile.php?Emp_No=<?php echo urlencode($employee['Emp_No']); ?>";
              }
            }
</script>
