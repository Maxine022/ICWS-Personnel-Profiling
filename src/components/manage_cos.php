  ...
  <div class="search-buttons-container row align-items-center mb-4">
    ...
    <div class="col-md-6 text-end">
      <div class="d-flex flex-wrap justify-content-end align-items-center gap-2">
        <button class="btn btn-primary btn-sm" onclick="window.location.href='http://192.168.1.26/ICWS-Personnel-Profiling/src/components/add_cos.php'"><i class="fas fa-plus"></i> Add</button>
        ...
        <button class="btn btn-warning btn-sm" onclick="window.location.href='http://192.168.1.26/ICWS-Personnel-Profiling/src/components/print.php'">Print</button>
      </div>
    </div>
  </div>
