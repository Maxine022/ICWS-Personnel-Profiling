  ...
  <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a class="breadcrumb-link" href="http://192.168.1.26/ICWS-Personnel-Profilingg/src/hero/home.php">Home</a></li>
  ...
  <div class="search-buttons-container row align-items-center mb-4">
    ...
    <div class="col-md-6 text-end">
      <div class="d-flex flex-wrap justify-content-end align-items-center gap-2">
        <button class="btn btn-primary btn-sm" onclick="window.location.href='http://192.168.1.26/ICWS-Personnel-Profiling/src/components/add_intern.php'"><i class="fas fa-plus"></i> Add</button>
  ...
  <div class="table-container">
    ...
    <?php foreach ($interns as $intern): ?>
        <tr id="row-<?= htmlspecialchars($intern['intern_id']) ?>">
            ...
            <td>
                <button class="btn btn-warning btn-sm" onclick="window.location.href='http://192.168.1.26/ICWS-Personnel-Profiling/src/components/edit_intern.php?intern_id=<?= urlencode($intern['intern_id']) ?>'">
...
<script>
  function editIntern(id) {
    window.location.href = `http://192.168.1.26/ICWS-Personnel-Profiling/src/components/edit_intern.php?id=${intern_id}`;
  }

  function deleteIntern(intern_id) {
  if (confirm("Are you sure you want to delete this intern?")) {
    fetch('http://192.168.1.26/ICWS-Personnel-Profiling/src/components/delete_intern.php', {
      method: 'POST',
      headers: {
