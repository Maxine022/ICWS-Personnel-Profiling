...
<div class="container mt-1">
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="http://192.168.1.26/ICWS-Personnel-Profiling/src/components/cocprint.php?Emp_No=<?= urlencode($emp_no) ?>" target="_blank" class="btn btn-info btn-sm text-gray">
