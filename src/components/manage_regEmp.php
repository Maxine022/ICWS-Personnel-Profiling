  ...
  <div class="search-buttons-container row align-items-center mb-4">
    ...
    <div class="col-md-6 text-end">
      <div class="d-flex flex-wrap justify-content-end align-items-center gap-2">
        <button class="btn btn-primary btn-sm" onclick="window.location.href='http://192.168.1.100/ICWS-Personnel-Profiling/src/components/add_regular_employee.php'"><i class="fas fa-plus"></i> Add</button>
        ...
        <button class="btn btn-warning btn-sm" onclick="window.location.href='http://192.168.1.100/ICWS-Personnel-Profiling/src/components/print.php'">
          Print
        </button>
    ...
    <table class="table table-striped table-bordered" id="personnelTable">
      ...
      <?php foreach ($regulars as $index => $p): ?>
        <tr>
          ...
          <td><?= number_format((float)$p['monthlySalary'], 2, '.', ',') ?></td>
