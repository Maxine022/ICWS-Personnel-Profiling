...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            ...
            if ($stmt->execute()) {
                header("Location: http://192.168.1.100/ICWS-Personnel-Profiling/src/components/manage_intern.php");
                exit;
            } else {
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a class="breadcrumb-link" href="http://192.168.1.100/ICWS-Personnel-Profiling/src/components/personnel_record.php">Manage Intern</a></li>
  ...
  <div class="form-wrapper">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-12 d-flex mt-5 gap-4">
        <button type="submit" onclick="http://192.168.1.100/ICWS-Personnel-Profiling/src/components/manage_intern.php" class="btn btn-primary px-4">Submit</button>
