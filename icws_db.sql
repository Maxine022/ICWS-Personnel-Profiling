...
INSERT INTO `personnel` (`personnel_id`, `Emp_No`, `emp_type`, `emp_status`, `full_name`, `position`, `division`, `contact_number`, `sex`, `birthdate`, `address`, `profile_picture`, `createdAt`, `updatedAt`) VALUES
(53, '1', 'Regular', 'Active', 'Maxine Grace', 'ACCOUNTING CLERK II', 'Administrative and Planning Division', 2147483647, 'Male', '0322-02-23', '23', '/uploads/profile_53.png', '2025-05-07 05:53:34', '2025-05-07 05:53:34');
...
(272, 53, 274, 1, 32, '2025-05-07 05:52:50', '2025-05-07 05:52:50');
...
(274, 53, 13, '6', 1, 36022, '2025-05-07 05:52:50', '2025-05-07 05:52:50');
...
INSERT INTO `user` (`user_id`, `email`, `password`, `fullName`, `remember_token`, `createdAt`, `updatedAt`) VALUES
(1, 'thea@gmail.com', '$2y$10$iC6e.l/.M1CMn//2J0nzcuaVjKVtEV2HSUoTBL2kfDe4h4MnXoBNO', 'Thea Ancog', '', '2025-04-04 03:33:39', '2025-05-07 05:22:53');
...
--
ALTER TABLE `personnel`
  MODIFY `personnel_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `reg_emp`
--
ALTER TABLE `reg_emp`
  MODIFY `regEmp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;

--
-- AUTO_INCREMENT for table `salary`
--
ALTER TABLE `salary`
  MODIFY `salary_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
